...
shaka.media.MediaSourceEngine = class {
  ...
  async appendBuffer(
    ...
    shaka.log.info('wli', 'appendBuffer 5');
    ...
    shaka.log.info('wli', 'appendBuffer 6');
    ...
    shaka.log.info('wli', 'appendBuffer 7');
  }
  ...
  append_(contentType, data) {
    ...
    shaka.log.info('wli', 'append_ 1', contentType,
        this.queues_[contentType].length);
    // This will trigger an 'updateend' event.
    this.sourceBuffers_[contentType].appendBuffer(data);
    shaka.log.info('wli', 'append_ 2');
  }
  ...
  onError_(contentType) {
    ...
    shaka.log.info('wli', 'onError_', contentType, code);
  ...
  onUpdateEnd_(contentType) {
    shaka.log.info('wli', 'onUpdateEnd_ 1', contentType);
    if (this.reloadingMediaSource_) {
      return;
    }
    const operation = this.queues_[contentType][0];
    ...
    shaka.log.info('wli', 'onUpdateEnd_ 2', contentType,
        this.queues_[contentType].length);
  }
  ...
  enqueueOperation_(contentType, start) {
    ...
    shaka.log.info('wli', 'enqueueOperation_', contentType,
        this.queues_[contentType].length);
